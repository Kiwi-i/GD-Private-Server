...
foreach($result as &$comment1) {
	if($comment1["commentID"]!=""){
		...
		$commentstring .= "2~".$commentText."~3~".$comment1["userID"]."~4~".$comment1["likes"]."~5~0~7~".$comment1["spam"]."~9~".$uploadDate."~6~".$comment1["commentID"]."~10~".$comment1["percent"];
